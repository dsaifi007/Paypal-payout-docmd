...
$(document).ready(function () {
        ...
        datatable = $('#insurance_claim').DataTable({
            ...
            "columnDefs": [
                {
                    "targets": [], //first, Fourth, seventh column
...
$('#insurance_claim').wrap("<div class='scrolledTable' style='overflow-y: auto; clear:both;'></div>");
