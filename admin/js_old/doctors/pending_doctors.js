...
$(document).ready(function () {
        ...
        datatable = $('#datatable1').DataTable({
            ...
            "ajax": {
                "url": site_url+"admin/doctors/pending_doctors/getdata",
                "type": "POST",
                //Custom Post
                "data": {"filter_data":fd}
            ...
            "columnDefs": [
                {
                    "targets": [0,1,3,4,5,7], //first, Fourth, seventh column
...
function update_user_status(user_id , status) {
  $.ajax({
      url : site_url+"admin/doctors/pending_doctors/update_user_status",
      cache: false,
      type: "POST",
      processData :true,
