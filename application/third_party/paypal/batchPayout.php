...
->setEmailSubject("You have a payment from testing account");

$batchHeader = array(
    'SenderBatchId' => uniqid(),
    'EmailSubject'  => 'You have a payment from testing account!'  
);

$PayoutItem = array();
$PayoutItem1 = array(array(
    'RecipientType' => 'EMAIL',     
    'Note'          => 'Thanks', 
    'Receiver'      => 'payments-buyer@docmdapp.com', 
    'SenderItemId'  => uniqid()   
),array(
    'RecipientType' => 'EMAIL',     
    'Note'          => 'Thanks', 
...
->setNote('Thanks you.')
->setReceiver('payments-buyer@docmdapp.com')
...
// #### Sender Item 2
// There are many different ways of assigning values in PayPal SDK. Here is anothe
    //r way where you could directly inject json string.
...
// #### Sender Item 3
// One more way of assigning values in constructor when creating
// instance of PayPalModel object. Injecting array.
