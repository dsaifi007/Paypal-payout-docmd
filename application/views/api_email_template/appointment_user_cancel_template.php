                                            ...
                                            <table align='center' style='background-color:#fff;' bgcolor='#333333' border='0' cellpadding='0' cellspacing='0' width='100%' data-module='Advanced Options' data-bgcolor='Main BG'>
                                                    ...
                                                    <tr>
                                                        <td style='text-align: center; line-height:20px;'>
                                                            <?php echo $message; ?>gujvbghjbghjghbj
                                                        </td>
                                                    </tr>
                                                    <br><br>
                                                    <tr>
                                                        <td align='center'>
                                                            <table align='center' style='width: 100%; border-collapse: collapse;  border: 1px solid #ddd;    border-spacing: 0;' bgcolor='#ffffff' border='0' class='display-width' cellpadding='0' cellspacing='0'>
                                                                <thead style='color: #fff;background: #ef5770;'>
                                                                    <tr>
                                                                        <th style='padding: 10px;border: 1px solid #d0d0d0;text-align:left'>P-Name</th>
                                                                        <th style='padding: 10px;border: 1px solid #d0d0d0;text-align:center'>D-Name</th>
                                                                        <th style='padding: 10px;border: 1px solid #d0d0d0;text-align:center'>Patient DateTime</th>
                                                                        <th style='padding: 10px;border: 1px solid #d0d0d0;text-align:center'>Status</th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                                    <tr>
                                                                        <td style='padding: 10px;border: 1px solid #d0d0d0;text-align:left'>
                                                                            <?php echo $appointment_detail['name']; ?>
                                                                        </td>
                                                                        <td style='padding: 10px;border: 1px solid #d0d0d0;text-align:center'>
                                                                            <?php echo $appointment_detail['doctor']; ?>
                                                                        </td>
                                                                        <td style='padding: 10px;border: 1px solid #d0d0d0;text-align:center'>
                                                                            <?php echo convert_timezone_into_pst($appointment_detail['patient_availability_date_and_time']); ?>
                                                                        </td>
                                                                        <td style='padding: 10px;border: 1px solid #d0d0d0;text-align:center'>
                                                                            <?php echo $appointment_detail['appointment_status']; ?>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
