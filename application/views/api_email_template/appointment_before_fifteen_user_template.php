                                                        ...
                                                        <td align='center'>
                                                            <table align='center' style='width: 100%; border-collapse: collapse;  border: 1px solid #ddd;    border-spacing: 0;' bgcolor='#ffffff' border='0' class='display-width' cellpadding='0' cellspacing='0'>
                                                                <thead style='color: #fff;background: #ef5770;'>
                                                                    <tr>
                                                                        <th style='padding: 10px;border: 1px solid #d0d0d0;text-align:center'>Doctor Name</th>
                                                                        <th style='padding: 10px;border: 1px solid #d0d0d0;text-align:center'>Date Time</th>
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td style='padding: 10px;border: 1px solid #d0d0d0;text-align:center'>
                                                                            <?php echo $appointment_detail['patient_availability_date_and_time']." PST"; ?>
                                                                        </td>
                                                                        <td style='padding: 10px;border: 1px solid #d0d0d0;text-align:center'>
                                                                            <?php echo $appointment_detail['type']; ?>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
