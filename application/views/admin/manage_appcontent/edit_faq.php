            ...
            <div class="col-md-10 col-xs-10 user-details">
                <div class="white-box">
                    <div class="card-body " id="bar-parent6">
                        ...
                        <?php echo form_open("admin/manage_app_content/manage_appcontent_controller/faq_edit_submited/3/".$items[0]['id'], ['class' => "edit_faq"]); ?>
                        <!-- .row -->
                        <div class="row text-center m-t-10">
                                ...
                                if (count($faq_cat)) {
                                    ...
                                    <select class="form-control" name="faq_cat_id">
                                        ...
                                        foreach ($faq_cat as $value) {
                                            $selected = ($value['id']==$items[0]['cat_id'])?"selected":'';
                                            ?>
                            ...
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width is-upgraded" data-upgraded=",MaterialTextfield">
                                ...
                                $ques_eng = [
                                    ...
                                    "name" => "question",
                                    "value" => $items[0]['qus_ans_eng'][0][0][0],
                            ...
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width is-upgraded" data-upgraded=",MaterialTextfield">
                                ...
                                $ques_eng = [
                                    "class" => "form-control-textarea m-t-20",
                                    "name" => "answer",
                                    "value" => $items[0]['qus_ans_eng'][0][0][1],
                            ...
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width is-upgraded" data-upgraded=",MaterialTextfield">
                                ...
                                $ques_eng = [
                                    ...
                                    "style" => "width:100%",
                                    "name" => "sp_question",
                                    "value" => $items[0]['qus_ans_eng'][0][1][0],
                            ...
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width is-upgraded" data-upgraded=",MaterialTextfield">
                                ...
                                $ques_eng = [
                                    "class" => "form-control-textarea m-t-20",
                                    "name" => "sp_answer",
                                    "value" => $items[0]['qus_ans_eng'][0][1][1],
                        ...
                        <div class="row text-center">
                            <div class="col-md-12">
                                <input type="submit" name="edit_faq_save" class="btn btn-circle btn-primary" value="Submit">
                            </div>
                        </div>
                        <?php echo form_close(); ?>
                    </div>
