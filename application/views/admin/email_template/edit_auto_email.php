            ...
            <div class="col-md-12">
                <div class="manage-users">
                    <div class="card card-topline-aqua">
                        ...
                        <div class="card-body">
                            <?php echo form_open_multipart("admin/email_template/emails_controller/edit_automatic_email", ["id" => "add_manual_email"]); ?>
                                ...
                                <div class="row  m-t-10 compose-mail">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-xs-12 b-r m-t-20">
                                        <div class="form-group">
                                            ...
                                            <a href="<?php echo base_url(); ?>assets/admin/img/email_template/<?php echo $item['file_name']; ?>" target='_blank' class="attach"><?php echo $item['file_name']; ?></a>
                                        </div>
                                        <input type="button" class="delbtn removebtn" style="width:100px" value="Remove">
