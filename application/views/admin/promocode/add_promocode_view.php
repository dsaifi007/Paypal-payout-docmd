        ...
        <div class="row">
            <div class="col-md-12 col-xs-12 user-details">
                <div class="white-box">
                    ...
                    <?php
                    $form_attr = ["id" => "promocode","onsubmit"=>"date_validtion(e)"];
                    echo form_open_multipart("admin/promocode/promocode_controller/add_promocode_info", $form_attr);
                    ?>
                    <?php
                    ...
                    <div class="card-body " id="bar-parent6">
                        ...
                        <div class="row text-center m-t-10">
                            <div class="col-md-6 col-sm-6">
                                ...
                                <div class="input-group m-b-20">	
                                    <div class="input-group m-b-20">
                                        &emsp;&emsp;<input type="file"  name='pharmacy_img' id="file-7" class="inputfile inputfile-6" data-multiple-caption="{count} files selected" multiple style="display:none" />
                                        <label for="file-7">&nbsp; Upload Logo<span></span>  <strong> <i class="fa fa-cloud-upload" aria-hidden="true"></i> Browse</strong>
                                    </div>
