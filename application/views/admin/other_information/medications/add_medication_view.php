        ...
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                ...
                <ol class="breadcrumb page-breadcrumb pull-right">
                    ...
                    <li>&nbsp;<a class="parent-item" href="<?php echo base_url(); ?>admin/other_information/medications_controller"><?php echo $this->lang->line("manage_other_information"); ?></a>&nbsp;<i class="fa fa-angle-right"></i>
                    </li>
            ...
            <div class="col-md-10 col-xs-10 user-details">
                <div class="white-box">
                    <div class="card-body " id="bar-parent6">
                        ...
                        <?php
                        $form_attr = ["id" => "add_medication", "class" => "form-horizontal"];
                        echo form_open_multipart("admin/other_information/medications_controller/add_medication_info", $form_attr);
                        ?>
                        <div class="row text-center m-t-10">
                        <div class="col-md-12">
                            <?php
                            $input_eng_name = ["name" => "name", "placeholder" => "Enter medication name(English)", "class" => "form-control"];
                        ...
                        <div class="col-md-12 m-t-20 m-b-20" >
                            <br>
                            <?php
                            $input_eng_name = ["name" => "sp_name", "placeholder" => "Enter medication name(Spanish)", "class" => "form-control"];
                            echo form_input($input_eng_name);
                            ?>
                        ...
                        <div class="col-md-7 col-sm-7">
                            <input type="file" name="medication_csv" id="file-7" class="inputfile inputfile-6  text-center" data-multiple-caption="{count} files selected" multiple style="display:none" />
                    ...
                    <div class="row text-center">
                        <div class="col-md-12">
                            <?php echo form_submit("medication_submit", "Submit", ["class" => "btn btn-info"]); ?>
