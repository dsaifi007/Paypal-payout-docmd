            ...
            <div class="col-md-10 col-xs-10 user-details">
                <div class="white-box">
                    <div class="card-body " id="bar-parent6">
                        ...
                        echo form_open_multipart("admin/other_information/visit_instruction_controller/edit_visit_instruction_info/".$items->id, $form_attr);
                        ?>
                ...
                'value'=>set_value('additional_info',$items->additional_info)
                            ...
                            <div class="col-md-12 m-t-20 m-b-20" >
                                ...
                                $input_add_info = ["name" => "sp_additional_info",
                                    ...
                                    "placeholder" => "Enter Additional Information",
                                    "rows" => "5", "aria-invalid" => "false"                                  ,
                                    'value'=>set_value('spn_additional_info',$items->sp_additional_info)
                                    ];
                                echo form_textarea($input_add_info);
                                ?>
