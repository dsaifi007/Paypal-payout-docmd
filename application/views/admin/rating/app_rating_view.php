                ...
                <div class="manage-users">
                    <div class="card card-topline-aqua">
                        ...
                        <div class="card-body">
                            ...
                            <div clas="row">
                                <div class="col-md-4">
                                    <?php echo form_open("admin/rating/app_rating_controller/index"); ?>
                                    <select class="form-control valid" name="id" onchange="this.form.submit()" aria-invalid="false">
                                        <option value="1" >User</option>
                                        <option value="2" <?php echo ($id !=1 )?"selected":""; ?> >Doctor</option>
...
<script>
    ...
    $(document).ready(function () {
        datatable = $('#rating_list_list').DataTable({
            ...
            "ajax": {
                "url": site_url + "admin/rating/app_rating_controller/getdata",
                "type": "POST",
                //Custom Post
                "data": {"id": id}
