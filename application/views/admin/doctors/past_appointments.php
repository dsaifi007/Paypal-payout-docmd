            ...
            <div class="page-title-breadcrumb">
                <ol class="breadcrumb page-breadcrumb pull-right">
                    <li><i class="fa fa-home"></i>&nbsp;
                        ...
                        <i class="fa fa-angle-right"></i>View Past Appointments
                    ...
                    <div class="card-body ">
                        ...
                        <div class="mdl-tabs mdl-js-tabs">
                            <div class="mdl-tabs__tab-bar">
                                ...
                                <a href="<?php echo base_url(); ?>admin/doctors/appointment_detail_controller/past_appointments/<?php echo $this->uri->segment(5); ?>" class="mdl-tabs__tab is-active">Past Appointments</a>
                                                    ...
                                                    if (count($past_appointment) > 0) {
                                                        foreach ($past_appointment as $value) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td> <a href="<?php echo base_url(); ?>admin/doctors/appointment_detail_controller/detail_past_appointment/<?php echo $value['id'] ?>/1"> View</a></td>
                                                            </tr>
                                                            <?php
                                                        }
                                                    } else {
