            ...
            <div class="page-title-breadcrumb">
                <ol class="breadcrumb page-breadcrumb pull-right">
                    <li><i class="fa fa-home"></i>&nbsp;
                        ...
                        <i class="fa fa-angle-right"></i><a class="parent-item" href="<?php echo base_url(); ?>admin/doctors/registered_doctors/doctor_view/<?php echo $this->uri->segment(5) ?>">Provider Detail</a>&nbsp;
                        ...
                        <i class="fa fa-angle-right"></i><a class="parent-item" href="#">Cancel Appointment</a>&nbsp;
                    ...
                    <div class="card-body ">
                        ...
                        <div class="mdl-tabs mdl-js-tabs">
                            <div class="mdl-tabs__tab-bar">
                                <a href="<?php echo base_url(); ?>admin/doctors/appointment_detail_controller/upcoming_appointments/<?php echo $this->uri->segment(5); ?>" class="mdl-tabs__tab ">Upcoming Appointments</a>
                                <a href="<?php echo base_url(); ?>admin/doctors/appointment_detail_controller/past_appointments/<?php echo $this->uri->segment(5); ?>" class="mdl-tabs__tab">Past Appointments</a>
                                <a href="<?php echo base_url(); ?>admin/doctors/appointment_detail_controller/cancel_appointments/<?php echo $this->uri->segment(5); ?>" class="mdl-tabs__tab is-active">Canceled Appointments</a>
                            </div>
                                    ...
                                    <div class="card card-topline-aqua">
                                        <div class="card-body">
                                            <table id="" class="display" style="width:100%;">
                                                ...
                                                <tbody>
                                                    <?php
                                                    if (count($cancel_appointment) > 0) {
                                                        $data ='';
                                                        foreach ($cancel_appointment as $value) {
            ...
            <div class="modal-body">
                <div class="card card-box">
                    ...
                    <div class="card-body " id="bar-parent">
                        <form action="<?php echo base_url(); ?>admin/users/appointment_detail_controller/cancel_appointments/<?php echo $this->uri->segment(5); ?>" method="POST" name="filter_data" id="filter_data">
