                ...
                <ol class="breadcrumb page-breadcrumb pull-right">
                   <li><i class="fa fa-home"></i>&nbsp;
                        ...
                        <a class="parent-item" href="<?php echo base_url(); ?>admin/users/manage_users/user_view/<?php echo $this->uri->segment(5) ?>"><?php echo $user_name['user_name'] ?></a><i class="fa fa-angle-right"></i>
                         <li class="active">Canceled Appointments Details</li>
                    </li>
                </ol>
            </div>
        </div>
                ...
                <div class="card-box appo-details">
                    ...
                    <div class="card-body ">
                        ...
                        <div class="mdl-tabs__tab-bar">
                                ...
                                <a href="<?php echo base_url();?>admin/users/appointment_detail_controller/cancel_appointments/<?php echo $this->uri->segment(5);?>" class="mdl-tabs__tab is-active">Canceled Appointments</a>
                            </div>
