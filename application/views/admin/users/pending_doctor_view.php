                ...
                <div class="manage-users">
                    <div class="card card-topline-aqua">
                        ...
                        <div class="card-body">
                            ...
                            <?php echo form_open("admin/doctors/pending_doctors/send_email_to_doctors", ["class" => "users_email_validation", "id" => "frm-example", "onsubmit" => "return tsextareavldt()"]); ?>
                            ...
                            <table  id="datatable1" class="table table-striped table-bordered">
                                <thead> 
                                    <tr>
                                        ...
                                        <th style="min-width:196px"><?php echo $this->lang->line("action"); ?></th>
                                    </tr>
                                </thead>
                                <tbody>
                                </tbody>
            ...
            <div class="modal-body">
                <div class="card card-box">
                    ...
                    <div class="card-body " id="bar-parent">
                        ...
                        ?>
                        <form action="<?php echo base_url(); ?>admin/doctors/pending_doctors/index" method="POST" name="filter_data" id="filter_data">
                ...
                <div class="casrd zcard-box">
                    ...
                    <div class="card-body " id="bar-parent">
                        ...
                        <div class="form-group pre-saved-email " >
                            ...
                            <textarea name="message" style="display:none"  id="message" disabled="disabled" class="form-control msg" placeholder="Enter Email text" ></textarea>
                        </div>
                        <div class="form-group">
                            <button type="submit" name="submit" style="display:none"  class="btn btn-primary submit-btn"><?php echo $this->lang->line("submit"); ?></button>
                        </div>
            ...
            <div class="modal-body">
                <div class="content">
                    <div class="col-md-12">
                        ...
                        <?php echo form_open("admin/doctors/pending_doctors/update_doctors_status"); ?>
