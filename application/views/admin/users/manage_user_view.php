...
<style>
    ...
    th.sorting_disabled {padding-right: 0px; min-width: 120px;}
    table.dataTable thead>tr>th.sorting {min-width: 120px;}
</style>
<?php
?>
<!-- start page content -->
            ...
            <div class="modal-body">
                <div class="card card-box">
                    ...
                    <div class="card-body " id="bar-parent">
                        <form action="<?php echo base_url(); ?>admin/users/manage_users" method="POST" name="filter_data" id="filter_data">
                            <div class="form-group row">
                                <label class="col-md-4 control-label"><?php echo $this->lang->line("gender"); ?></label>
                                <div class="input-group col-md-8">
                                    <div class="radio">
                                        <input id="male" name="ptnt_gender" type="radio" value='male'  />
                                        <label style="line-height: normal;" for="male"><?php echo $this->lang->line("male"); ?></label>
                                    </div> 
                                    <div class="radio">
                                        <input id="female" name="ptnt_gender" type="radio" value='female' >
                                        <label for="female" style="line-height: normal;"><?php echo $this->lang->line("female"); ?></label>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="input-group col-md-8">
                                    <?php if (count(get_all_state()) > 0) {
                                        ?>
                                        <select name="address_state" class="form-control" id="state">
                                            <option value='0'>Select State</option>
                                            <?php
                                            foreach (get_all_state() as $key => $value) {
                                                ?>
                                                <option value="<?php echo trim($value['state_code']); ?>"><?php echo $value['state_code']; ?></option>
                                            <?php } ?>
                                        </select>
                                    <?php } ?>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="input-group col-md-8">
                                    <?php if (count($rating) > 0) {
                                        ?>
                                        <select name="avg_rating" class="form-control" id="state">
                                            <option value='0'>Select Rating</option>
                                            <?php
                                            foreach ($rating as $key => $value) {
                                                ?>
                                                <option value="<?php echo trim($value['avg_rating']); ?>"><?php echo $value['avg_rating']; ?></option>
                                            <?php } ?>
                                        </select>
                                    <?php } ?>
                                </div>
                            ...
                            <div class="radio radio-aqua">
                                <input id="ptnt_provider" name="ptnt_provider"  value='IS NOT NULL' type="radio" >
                                <label for="ptnt_provider" style="line-height:normal;">
                                    <?php echo $this->lang->line("health_insurance"); ?>
                                </label>
                            </div>

                            <button type="submit" class="btn btn-round btn-success">Filter</button>
                        </form>
                    </div>
                </div>  
            </div>
...
<?php
if ($filterdata != '' && isset($filterdata)) {
