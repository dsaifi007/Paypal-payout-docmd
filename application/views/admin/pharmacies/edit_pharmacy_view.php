    ...
    <div class="page-content">
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                <div class="pull-left">
                    <div class="page-title"><?php echo ucfirst($items->pharmacy_name); ?></div>
                </div>
                <ol class="breadcrumb page-breadcrumb pull-right">
                    <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item" href="<?php echo base_url(); ?>dahsboard">Home</a>&nbsp;<i class="fa fa-angle-right"></i>
                    </li>
                     <li>&nbsp;<a class="parent-item" href="<?php echo base_url(); ?>admin/pharmacies/pharmacies_controller">Manage Pharmacies</a>&nbsp;<i class="fa fa-angle-right"></i>
                    </li>
                    <li class="active"><?php echo ucfirst($items->pharmacy_name); ?></li>
                </ol>
            </div>
        </div>
        <!-- add content here -->
        <div class="row">
            <div class="col-md-12 col-xs-12 user-details">
                <?php
                //"onsubmit" => "check_start_end_time(event)"
                    ...
                    <div class="patient-profile">
                        ...
                        <div class="form-group row has-success">
                            ...
                            <div class="compose-editor">
                                <input type="file"  name="pharmacy_img" id="file" >
                            </div>
                        </div>
                    </div>
                                        ...
                                        foreach ($pharmacy_timing as $key => $value) {
                                            ...
                                            <div class="col-md-4 a">
                                                <div class="input-group m-b-20">	<span class="input-group-addon"><i class="fa fa-clock-o" aria-hidden="true"></i></span>
                                                    <?php
                                                    $start_time = ["name" => "start_time[]", "disabled" => "disabled", "type" => "time", "class" => "form-control start_time", "placeholder" => $this->lang->line("start_time"), "id" => "start_time", 'value' => @$value->time->from];
                                            ...
                                            <div class="col-md-4 a" >
                                                <div class="input-group m-b-20">	<span class="input-group-addon"><i class="fa fa-clock-o" aria-hidden="true"></i></span>
                                                    <?php
                                                    $end_time = ["name" => "end_time[]", "disabled" => "disabled", "type" => "time", "class" => "form-control end_time", "placeholder" => $this->lang->line("end_time"), "id" => "end_time", 'value' => @$value->time->to];
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div>
                                            ...
                                            <input id="hidden" disabled="disabled" name="address_location" type="hidden" value="<?php echo $items->latitude . ',' . $items->latitude; ?>">
                                        </div><br>
...
//        $.ajax({
//            type:'POST',
//            url: site_url + "admin/pharmacies/pharmacies_controller/uploade_image/<?php echo $this->uri->segment(5); ?>",
//            data:formData,
//            cache:false,
//            contentType: false,
//            processData: false,
...
//});
    ...
    function a() {
        $.ajax({
            url: site_url + "admin/pharmacies/pharmacies_controller/uploade_image",
            type: "POST",
