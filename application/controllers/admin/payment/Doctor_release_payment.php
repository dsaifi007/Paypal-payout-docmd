...
class Doctor_release_payment extends MY_Controller {

    protected $data = [];
    private $language_file = "payment/doctor_payment";
    protected $model = 'admin/payment/doctor_release_payment_model';
    ...
    public function index() {
        ...
        $this->data['view'] ="admin/payment/doctor_release_payment_view";
