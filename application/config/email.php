...
| 
*/
$config['from']="danishk@chromeinfotech.com";
$config['subject']="Forget Password";
$config['message']="Your Temprary password is";
...
$config['smtp_user']        = 'contact@docmdapp.com';
$config['smtp_pass']        = 'DOCMD123!';
