...
class Doctor_release_payment_model extends CI_Model {
    ...
    function _get_order_list_query($post) {
        ...
        $this->db->where(["appointment.status" => "6", "appointment.is_payment_released" => $this->pay_status, "doctor_payment_methods.take_payment_status" => "yes"]);
    ...
    public function update_payment_failed($id, $msg) {
        $this->db->insert("doctor_payment_failed_histroy", ["doctor_id" => $id, "message" => $msg]);
    }
